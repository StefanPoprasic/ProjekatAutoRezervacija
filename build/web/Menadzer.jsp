<%-- 
    Document   : Menadzer
    Created on : Feb 27, 2020, 1:54:34 PM
    Author     : POPRASIC
--%>
            ...
            <table align="center" background="black">
                ...
                <c:forEach items="${automobils}" var="automobil">
                    <tr>
                        ...
                        <form action="IzmenaMenadzera2" method="post">
                            <input size="2" type="hidden" name="idAuto" value="${automobil.idAuto}">
                            <td><input size=20 type="submit" value="Obrisi"></td>
                        </form>
                     </form>
                        <td><a href="InfoIzmena?idInf=${automobil.idInfo}">Dodatne informacije</a></td>
                     </tr>
                  ...
                  <form action="IzmenaMenadzer" method="post">
                <table>
                    ...
                    <tr>
                        ...
                        <td><input size=20 type="submit" value="Izmeni"></td>
                            ...
                            <table>
                        <form action="NovAuto.jsp" method="post">
                            <input size="2" type="hidden" name="idAuto" value="${automobil.idAuto}">
                            <td><input size=20 type="submit" value="Unesi nov automobil"></td>
