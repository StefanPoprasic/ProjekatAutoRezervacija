...
public class Login extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String menadzer1="menadzer@gmail.com";
        if(email.isEmpty() || password.isEmpty()){
            ...
            try{
                ...
                if(rs.next()){
                    ...
                    sesija.setAttribute("poruka", email);
                    request.getRequestDispatcher("Admin.jsp").forward(request, response);
                }
                   else if(email.equals(menadzer1)){
                  ...
                  request.getRequestDispatcher("Menadzer").forward(request, response);  
                    ...
                    request.getRequestDispatcher("KorisnikLogin").forward(request, response);
                        ...
                        request.setAttribute("Poruka", "Podaci nisu tacni pokusajte ponovo");
            request.getRequestDispatcher("Logovanje.jsp").forward(request, response);
