 ...
 * @author POPRASIC
 */
public class NovAuto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet NovAuto</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet NovAuto at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String menjac=(String)request.getParameter("menjac");
        ...
        String cena=(String)request.getParameter("cena");
          ...
          if(marka.isEmpty() || gorivo.isEmpty() || menjac.isEmpty() || karoserija.isEmpty() || cena.isEmpty()){
              request.setAttribute("Poruka","Unesite sve podatke!");
                    request.getRequestDispatcher("NovAuto.jsp").forward(request, response);
          }
          else{
        try{
                    ...
                    st.executeUpdate("insert into automobil(marka,gorivo,menjac,karoserija,cena,serija)"
                            + " VALUES('"+marka+"','"+gorivo+"','"+menjac+"','"+karoserija+"','"+cena+"','"+serija+"');");
